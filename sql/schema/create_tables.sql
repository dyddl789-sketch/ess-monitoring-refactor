...
ADD deleted_yn CHAR(1) DEFAULT 'N'
COMMENT '논리삭제 여부';
...
ALTER TABLE board
ADD board_type VARCHAR(30) DEFAULT 'GENERAL'
COMMENT '게시글 유형';

ALTER TABLE board
ADD CONSTRAINT chk_board_type
CHECK (board_type IN ('GENERAL', 'NOTICE', 'QNA'));


ALTER TABLE ess_device
ADD CONSTRAINT chk_deleted_yn
